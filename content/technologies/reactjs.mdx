...
using [map()](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/map) to create a new array from an initial set of data, and then filtering the result
using [filter()](https://developer.mozilla.org/en/docs/Web/JavaScript/Reference/Global_Objects/Array/filter) as a **NOTE:**_map, filter think of them as a factory or containers that given an initial list (array of things), transform it into something else, while keeping that same original list intact._
...
> [**Imperative Code**](https://tylermcginnis.com/imperative-vs-declarative-programming/), instructs code for how to perform each step.
> [**Declarative code**](https://stackoverflow.com/questions/33655534/difference-between-declarative-and-imperative-in-react-js), instructs code for what we want to be done, and let code take care of performing the steps.
...
First of all — the [_Virtual DOM_](https://reactjs.org/docs/optimizing-performance.html#avoid-reconciliation) was not invented by React, but React uses it and provides it for free.
...
[Diffing](https://reactjs.org/docs/reconciliation.html#the-diffing-algorithm) determines how to make efficient changes to the DOM. With diffing, old DOM nodes are taken out and replaced only
...
💎 [3a5a7260aebd28234cac5f63fa27ab3ef5a9f3ca](https://github.com/moelzanaty3/react-redux-guide-with-zanaty/tree/3a5a7260aebd28234cac5f63fa27ab3ef5a9f3ca).
...
The React docs say that you can use [**props.children**](https://codeburst.io/a-quick-intro-to-reacts-props-children-cb3d2fce4891) on components that represent `generic boxes`
...
💎 [6e1a7c36dec7eb028b8c46efe790c93f6f7ae9d9](https://github.com/moelzanaty3/react-redux-guide-with-zanaty/tree/6e1a7c36dec7eb028b8c46efe790c93f6f7ae9d9).
...
<iframe width="100%" height="600" src="https://projects.wojtekmaj.pl/react-lifecycle-methods-diagram/" title="React Life Cycle" frameborder="0" ></iframe>
...
💎 [39c564868e4c0e2fc1dc5c609b7481e94c72a9ea](https://github.com/moelzanaty3/react-redux-guide-with-zanaty/commit/39c564868e4c0e2fc1dc5c609b7481e94c72a9ea).
...
💎 [02045ab8b4c6fa78f3dd105a375b5f4934bde8c8](https://github.com/moelzanaty3/react-redux-guide-with-zanaty/commit/02045ab8b4c6fa78f3dd105a375b5f4934bde8c8).
...
💎 [ea00c52a8ddd3440c75581d34637da3d5e051879](https://github.com/moelzanaty3/react-redux-guide-with-zanaty/commit/ea00c52a8ddd3440c75581d34637da3d5e051879).
...
💎 [b678eae9198cddb3a7b7119265bf02e57e496962](https://github.com/moelzanaty3/react-redux-guide-with-zanaty/commit/b678eae9198cddb3a7b7119265bf02e57e496962).
...
## Acknowledgment
<Tip>
  I am not writing all the content here, most of the explanations based on the workshop  {" "}
  <a href="https://www.linkedin.com/in/btholt/" target="_blank"> Brian Holt</a> ©
</Tip>
